    ...
    try {
      ...
      if (inventoryData?.recent_activity && inventoryData.recent_activity.length > 0) {
        inventoryData.recent_activity.forEach((activity, index) => {
          ...
          pdf.text(`• ${activity.action}:`, 25, yPosition);
        ...
        pdf.text('• No recent activity', 25, yPosition);
      }
          ...
          <div className="charts-section">
            <div className="chart-container full-width">
              ...
              <div className="quick-actions">
                ...
                >
                  {generatingReport ? '⏳ Generating Report...' : '📋 Generate PDF Report'}
                </button>
              </div>
            </div>
          </div>
    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        <div className="sidebar-header">
          <h2 className="moonberry-logo">MOON<span className="logo-o">🍓</span>BERRY</h2>
        ...
        <nav className="sidebar-nav">
          <ul>
            <li className={activeSection === 'dashboard' ? 'active' : ''}>
              <span onClick={() => setActiveSection('dashboard')}>📊 Dashboard</span>
            </li>
            <li className={activeSection === 'flavors' ? 'active' : ''}>
              <span onClick={() => setActiveSection('flavors')}>🧋 Milk Tea Flavors</span>
            </li>
            <li className={activeSection === 'ingredients' ? 'active' : ''}>
              <span onClick={() => setActiveSection('ingredients')}>🍓 Ingredients</span>
            </li>
            <li className={activeSection === 'utensils' ? 'active' : ''}>
              <span onClick={() => setActiveSection('utensils')}>🔪 Utensils & Equipment</span>
            </li>
            <li className={activeSection === 'employees' ? 'active' : ''}>
              <span onClick={() => setActiveSection('employees')}>👥 Employees</span>
            </li>
            <li className={activeSection === 'suppliers' ? 'active' : ''}>
              <span onClick={() => setActiveSection('suppliers')}>🚚 Suppliers</span>
            </li>
          </ul>
        </nav>
